...
export default function Billing() {
  ...
  const energyHt = currentBilling?.energy_cost_ht ?? 0;
  const tvaFcfa = currentBilling?.tva_fcfa ?? 0;
  const totalFcfa =
            ...
            <div className="grid grid-cols-3 gap-2 text-xs">
              <div className="border border-slate-200 rounded px-3 py-2 bg-slate-50">
                ...
                <p className="font-bold text-slate-800">
                  {energyHt.toLocaleString("fr-FR")} FCFA
                </p>
              </div>
              <div className="border border-slate-200 rounded px-3 py-2 bg-slate-50">
                <p className="text-[10px] text-slate-400 uppercase tracking-wider">
                ...
                <p className="font-bold text-slate-800">
                  {tvaFcfa.toLocaleString("fr-FR")} FCFA
                </p>
              </div>
              <div className="border border-slate-200 rounded px-3 py-2 bg-slate-50">
                <p className="text-[10px] text-slate-400 uppercase tracking-wider">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-slate-50/50 border-b border-slate-200 text-xs uppercase tracking-wider text-slate-500">
                ...
                <th className="px-6 py-3 font-semibold text-right text-blue-600">
                  Tarif (FCFA / kWh)
                </th>
                <th className="px-6 py-3 font-semibold text-right text-slate-500">
                  TVA
                </th>
              </tr>
            </thead>
            <tbody>
              {loadingTariffs ? (
                <tr>
                  <td
                    colSpan="4"
                    className="px-6 py-6 text-center text-slate-400 animate-pulse text-xs"
                  >
                    Chargement…
                  </td>
                </tr>
